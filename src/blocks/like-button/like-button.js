...
$('.js-like-button__button').on('click', function () {
  ...
  if ($(this).hasClass('like-button__button_active')) {
    ...
    $(this)
      .find('.js-like-button__number')
      .removeClass('like-button__number_active');
    $(this)
      .find('.material-icons')
      .removeClass('material-icons__favorite')
      .addClass('material-icons__favorite-border')
    ...
    $(this)
      .find('.js-like-button__number')
      .addClass('like-button__number_active');
    $(this)
      .find('.material-icons')
      .removeClass('material-icons__favorite-border')
      .addClass('material-icons__favorite')
      .text('favorite');
    $(this).find('.js-like-button__number').text(number);
  }
});
